# MASTER_GOAL.md — ask-notion

## Purpose

This is the **master goal** for building ask-notion. It does not implement the gem
directly. It loads and follows the detailed build plan at:

> **GOAL.md:** `/Users/kaka/Code/ask-rb/ask-notion/GOAL.md`
...
- **Source:** `/Users/kaka/Code/ask-rb/ask-notion/lib/`
- **Tests:** `/Users/kaka/Code/ask-rb/ask-notion/test/`
- **Goal:** `/Users/kaka/Code/ask-rb/ask-notion/GOAL.md`
- **Remote:** `git@github.com:ask-rb/ask-notion.git`
...
The GOAL.md at `/Users/kaka/Code/ask-rb/ask-notion/GOAL.md` contains the full
...
See the bottom of `/Users/kaka/Code/ask-rb/ask-notion/GOAL.md` for the full checklist.
